        ...
        <div className="flex items-center gap-x-[20px] w-full">
            ...
            <div className="flex flex-col w-full">
                ...
                <div className="flex justify-between">
                    <p className="font-[inter-regular] text-[#103D62] text-[12px] md:text-[14px]">{company_name}</p>
                    <p className="font-[inter-regular] text-[#103D62] text-[12px] md:text-[14px]">{year}</p>
                </div>
            </div>
